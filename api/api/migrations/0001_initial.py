...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='VulnRemove',
            fields=[
                ('remove_id', models.CharField(max_length=36, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='VulnFix',
            fields=[
                ('fix_id', models.CharField(max_length=36, primary_key=True, serialize=False, unique=True)),
                ('fix_url', models.URLField(unique=True)),
                ('removal_id', models.CharField(max_length=36)),
        ...
        migrations.CreateModel(
            name='TestSuite',
            fields=[
                ('suite_id', models.CharField(max_length=36, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Stig',
            fields=[
                ('stig_id', models.CharField(max_length=36, primary_key=True, serialize=False, unique=True)),
                ('project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.project')),
            ],
        ),
        migrations.CreateModel(
            name='Device',
            fields=[
                ('device_id', models.CharField(max_length=36, primary_key=True, serialize=False, unique=True)),
                ('last_run_time', models.CharField(max_length=36)),
